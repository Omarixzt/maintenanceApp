        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              // يعتمد على الثيم الافتراضي (كحلي داكن)
            ...
            ElevatedButton(
              onPressed: () {
                provider.saveSettings(_tokenCtrl.text, _chatIdCtrl.text, _macCtrl.text);
            ...
            ElevatedButton.icon(
              ...
              // لون مختلف لهذا الزر للإشارة إلى التقرير النهائي (أحمر ALBAIK)
